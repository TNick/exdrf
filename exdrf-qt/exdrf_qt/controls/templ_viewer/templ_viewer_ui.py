...
class Ui_TemplViewer:
    ...
    def setup_ui(self, TemplViewer):
        ...
        self.c_splitter = QtWidgets.QSplitter(parent=TemplViewer)
        self.c_splitter.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        ...
        self.c_stacked = QtWidgets.QStackedWidget(parent=self.c_splitter)
        self.c_stacked.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.c_stacked.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        ...
        self.layoutWidget = QtWidgets.QWidget(parent=self.c_splitter)
        ...
        self.c_vars = QtWidgets.QTreeView(parent=self.layoutWidget)
        ...
        self.c_var_label = QtWidgets.QLabel(parent=self.layoutWidget)
        self.c_var_label.setObjectName("c_var_label")
        self.lay_template_source.addWidget(self.c_var_label)
        self.c_templ = QtWidgets.QLineEdit(parent=self.layoutWidget)
        self.c_templ.setObjectName("c_templ")
        self.lay_template_source.addWidget(self.c_templ)
        self.c_sel_templ = QtWidgets.QToolButton(parent=self.layoutWidget)
    ...
    def retranslate_ui(self, TemplViewer):
        TemplViewer.setWindowTitle(
            self.ctx.t("gui.templ_viewer.window_title", "Template with data")
        )
        self.c_var_label.setText(
            self.ctx.t("gui.templ_viewer.c_var_label", "Template")
        )
        self.c_sel_templ.setText(
            self.ctx.t("gui.templ_viewer.c_sel_templ", "...")
        )
