...
class QtChildRel(DrfRelated):
    """Relations editor where the target records are Child instances."""
    ...
    def __init__(self, ctx: "QtContext", **kwargs):
        ...
        super().__init__(
            ...
            src_model=kwargs.pop(
                "src_model",
                ctx.get_ovr(
                    "exdrf_dev.qt_gen.db.children." "rel.src_model.children",
                    QtChildFuMo,
                ),
            ),
            src_db_model=kwargs.pop(
                "src_db_model",
                ctx.get_ovr(
                    "exdrf_dev.qt_gen.db.children." "rel.src_db_model.children",
                    DbChild,
                ),
            ),
            **kwargs,
