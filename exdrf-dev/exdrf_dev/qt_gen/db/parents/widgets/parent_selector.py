    ...
    def __init__(self, ctx: "QtContext", **kwargs):
        ...
        super().__init__(
            ...
            editor_class=kwargs.pop(
                "editor_class",
                ctx.get_ovr(
                    "exdrf_dev.qt_gen.db.parents.selector.editor",
                    QtParentEditor,
                ),
            ),
            ctx=ctx,
        ...
        safe_hook_call(exdrf_qt_pm.hook.parent_sise_created, widget=self)
...
class QtParentMuSe(DrfSelMultiEditor):
    ...
    def __init__(self, ctx: "QtContext", **kwargs):
        ...
        # Inform plugins that the widget has been created.
        safe_hook_call(exdrf_qt_pm.hook.parent_muse_created, widget=self)
